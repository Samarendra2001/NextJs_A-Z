            ...
            <section className="w-full lg:w-[50%] flex flex-col md:px-2 lg:px-0 p-5 lg:p-10">
              <div className="w-full flex justify-start flex-col h-auto lg:pt-7">
                <span className="flex space-x-2">
                  ...
                  <span className="font-medium dark:text-white text-gray-600 dark:hover:bg-gradient-to-r dark:hover:from-[#1A75FF] dark:hover:to-[#FF007F] dark:hover:bg-clip-text dark:hover:text-transparent transition duration-300">
                  Welcome to a community where talent meets opportunity___
                  </span>
                </span>
                <h1 className="text-3xl dark:text-white mt-5 lg:text-7xl text-black font-extrabold dark:hover:bg-gradient-to-r dark:hover:from-purple-400 dark:hover:via-pink-500 dark:hover:to-red-500 dark:hover:bg-clip-text dark:hover:text-transparent transition duration-300 ">
                  Helping professionals and businesses grow, one job at a time.
                </h1>
